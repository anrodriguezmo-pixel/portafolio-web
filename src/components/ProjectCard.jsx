  ...
  return (
    <ScrollReveal delay={delay} className="h-full">
      <button
        ...
        className="group text-left w-full h-full flex flex-col bg-white/60 rounded-2xl overflow-hidden border border-tinta/10 hover:border-rojo/40 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-tinta/10"
      >
